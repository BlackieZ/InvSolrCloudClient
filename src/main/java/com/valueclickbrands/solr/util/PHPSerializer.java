...
public class PHPSerializer {
	public static Logger logger=Logger.getLogger(PHPSerializer.class);
	...
	public static Object unserialize(byte[] ss, Class cls, String charset)
		...
		UnSerializeResult urs = unserialize(stream, new HashMap(), hv, new HashMap(),
				charset);
		if(urs==null){
//			logger.info("unserialize error:"+new String(ss));
			
			return null;
		}
		Object result=urs.value;
