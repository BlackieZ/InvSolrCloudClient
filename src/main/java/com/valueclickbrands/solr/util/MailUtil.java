...
public class MailUtil {
	...
	private static MailUtil mail = null;
	...
	private MailUtil(String host, String user, String password) {
		this.host = host;
		this.user = user;
	...
	private MailUtil(String host, String user, String password, String mail_auth) {
		this.host = host;
		this.user = user;
		this.password = password;
	...
	public static MailUtil newInstance(String host, String user, String password) {
		if (mail == null) {
			mail = new MailUtil(host, user, password);
		}
		return mail;
	}
	public static MailUtil newInstance(String host, String user, String password, String mail_auth) {
		if (mail == null) {
			mail = new MailUtil(host, user, password, mail_auth);
		}
		return mail;
	}
